           ...
           <div class="panel-body"><!-- panel-body Begin -->
               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <select name="product_cat" class="form-control"><!-- form-control Begin -->
                              ...
                              <option> Sélectionner la catégorie du produit </option>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <label class="col-md-3 control-label"> Mot clé du produit </label> 
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="submit" value="Insérer le produit" type="submit" class="btn btn-primary form-control">
...
if (isset($_POST['submit'])){
    ...
    $temp_name13 = $_FILES['product_img3']['tmp_name'];

    move_uploaded_file($temp_name1,"product_images/$product_img1");
    move_uploaded_file($temp_name2,"product_images/$product_img3");
    ...
    if($run_product){
        ...
        echo "<script> alert('Votre produit à bien été ajouté') </script>";
