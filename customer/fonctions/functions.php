...
//fin fonction getPCats

///debut fonction getCats
function getCats(){
        ...
        if($count==0){
            ...
            echo "
                ...
                <div class='box'>
                    ...
                    <h1> Il n'y a aucun produit dans cette catégorie </h1>
...
function total_price(){
    ...
    $run_panier = mysqli_query($db,$select_panier);
